...
use aoc23::{
    ...
    day21a, day21b, day22a, day22b, day23a, day23b, day24a, day24b, day25a, day2a, day2b, day3a,
    day3b, day4a, day4b, day5a, day5b, day6a, day6b, day7a, day7b, day8a, day8b, day9a, day9b,
};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("day12b", |b| b.iter(day12b::solve_day));
    ...
    c.bench_function("day22a", |b| b.iter(day22a::solve_day));
    c.bench_function("day22b", |b| b.iter(day22b::solve_day));
    c.bench_function("day23a", |b| b.iter(day23a::solve_day));
